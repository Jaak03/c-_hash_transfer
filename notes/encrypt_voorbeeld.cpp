...
std::vector<unsigned char> PaddedTxt(txt.begin(), txt.end());   // Easier to Pad as a vector********************************************convert na 'n vector van array
for(int i=0; i < RequiredPadding; i++){
PaddedTxt.push_back(0); //  Increase the size of the string by
}                           //  how much padding is necessary

unsigned char * UserData = &PaddedTxt[0];// Get the padded text as an unsigned char array***********************************************convert na array van 'n vector
